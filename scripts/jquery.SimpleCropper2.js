...
(function ($) {
    ...
    $.fn.simpleCropper = function (onComplete) {
        ...
        var jcrop_api;
        var bottom_html = "<input type='file' id='fileInput' name='files[]'/ accept='image/*'><canvas id='myCanvas' style='display:none;'></canvas><canvas id='myCanvas2' style='display:none;'></canvas><div id='modal'></div><div id='preview'><div class='buttons'><div class='cancel'></div><div class='ok'></div></div></div>";
                ...
                reader.onload = function (e) {
                    ...
                    current_image.onload = function () {
                        ...
                        ias = $(this).Jcrop({
                            ...
                            bgColor: '#747474',
                            bgOpacity: .1,
                            // aspectRatio: aspX / aspY, // CUSTOM NIMESH
        ...
        function preview() {
            ...
            canvas.width = x2*2;
            canvas.height = y2*2;
            context.drawImage(current_image, x1, y1, x2*2, y2*2, 0, 0, canvas.width, canvas.height);
			
			
			var canvas2 = document.getElementById('myCanvas2');
            var context2 = canvas2.getContext('2d');

            // Delete previous image on canvas2
			...
			canvas2.width = aspX;
            canvas2.height = aspY;
            context2.drawImage(current_image, (x1 * kw), (y1 * kh), (sw * kw), (sh * kh), 0, 0, aspX, aspY);

            // Convert canvas2 image to normal img
